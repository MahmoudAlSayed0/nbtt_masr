...
class AbuseConfirmationPage extends StatefulWidget {
  ...
  const AbuseConfirmationPage(
      {Key? key, required this.model, required this.listOfObjects})
      : super(key: key);
            ...
            : SingleChildScrollView(
                child: Column(
                  children: [
                    ...
                    Visibility(
                      visible: widget.model.pc == 1 ? true : false,
                            ...
                            child: TextButton(
                              onPressed: () async {
                                ...
                                try {
                                  ...
                                  final result = await violationService
                                      .createMissingKid(widget.model);
                                  setState(() {
                                    isLoading = true;
                                  });
